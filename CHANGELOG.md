...
- Added debug functionality for vis1 widgets (file synchronization pattern is now 'js', 'map', 'css', 'html', 'png', 'jpg'), visdebug is now called on startup if the widgets folder exists.
